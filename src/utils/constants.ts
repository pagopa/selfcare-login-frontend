...
export const ROUTE_TERMS_AND_CONDITION =
  (isPnpg ? BASE_ROUTE.replace('/auth/', '/') : BASE_ROUTE) + '/termini-di-servizio';
export const ROUTE_PRIVACY_DISCLAIMER =
  (isPnpg ? BASE_ROUTE.replace('/auth/', '/') : BASE_ROUTE) + '/informativa-privacy';
