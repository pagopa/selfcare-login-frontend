...
import { SPID_CIE_ENTITY_ID, URL_API_LOGIN, URL_FE_LANDING } from '../../utils/env';
import { ENABLE_LANDING_REDIRECT } from '../../utils/constants';
import { URL_FILE_PRIVACY_DISCLAIMER, URL_FILE_TERMS_AND_CONDITIONS } from '../../utils/env';
        ...
        <Grid container item justifyContent="center">
          <Grid item xs={6}>
            ...
            >
              ...
              <Link href={URL_FILE_PRIVACY_DISCLAIMER}>{'Informativa Privacy'}</Link>
              {' e i '}
              <Link href={URL_FILE_TERMS_AND_CONDITIONS}>{'Termini e condizioni d’uso'}</Link>
